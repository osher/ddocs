/**
   IMPORTANT NOTE: 
      ...
      This file is taken from: https://github.com/mikeal/node.couchapp.js/blob/master/main.js
      The indentation style also deems to preserves mikael's style (2 spaces for block - like for line break).
      
      For the following reason:
      https://github.com/mikeal/node.couchapp.js/issues/104

      Should this issue be resolved well - the package then must use the original couchapp module
...
var path = require('path')
  ...
  , mimetypes = require(/* PUT BACK ON PR: './mimetypes')*/'couchapp/mimetypes')
